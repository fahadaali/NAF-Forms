...
export default function MembersManager({
  ...
  async function patch(userId: string, body: Record<string, unknown>) {
    ...
    /* الفعل نافذ محلياً فور كتابته، والناقص إظهارُه في المركز. فيُفصل ما
       تمّ عمّا لم يتمّ، ولا يُقال «فشل» لفعلٍ نُفِّذ.

       وصار للمنح نصّه المسجَّل بعد أن كان يأخذ «تعذّر الاتصال»: تلك لطلبٍ
       لم يصل، وهذا فعلٌ وصل ونُفِّذ ولم يُبلَّغ به طرفٌ ثانٍ — والفرق أن
       الأولى تدفع المسؤول إلى إعادة منحٍ قائم. `naf-terms.md` §١٠. */
