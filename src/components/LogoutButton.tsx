/* مُستبدَل — لم يعد مستهلَكاً.
   تسجيل الخروج صار بنداً داخل قائمة الحساب في `ShellChrome`، ومنطق
   التنقّل الكامل بالمتصفّح نُقل إليه كما هو. أُبقي الملف ولا يُستأنف
   استعماله — زرّ خروج ثانٍ يعيد الاختلاف الذي وُحِّد. */
