...
const PUBLIC_PREFIXES = [
  ...
  // الواجهة البرمجية لقراءة الردود: حارسها رمزُ النموذج لا جلسةُ المتصفّح.
  // المنادي خادمٌ خارجي (Zapier، Make، سكربت) لا جلسة له هنا. وهي مغلقة
  // افتراضاً لكل نموذج، ويفتحها صاحبه صراحةً من تبويب التكاملات، ويدوّر
  // رمزها متى شاء. والمسار **يفحص أن مالك النموذج ما زال عضواً نشطاً في
  // كل طلب** — فمن سُحب وصولُه مركزياً يتوقّف مفتاحه معه.
  "/api/v1/",
];
