...
- عمود `url` **مسار الاستقبال كاملاً**:
  `https://naf-forms.naflaw-sa.workers.dev/auth/callback` — مؤكَّد ومسجَّل.
  وأصلٌ بلا مسار يوصل المستخدم إلى الصفحة الرئيسية ومعه رمزُ عبور لا يقرؤه
